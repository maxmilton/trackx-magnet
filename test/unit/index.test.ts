...
describe('dist files', () => {
  ...
  const distFiles: [filename: string, type: string, minBytes?: number, maxBytes?: number][] = [
    // ['health.js', 'text/javascript;charset=utf-8', 700, 800],
    ['icon16.png', 'image/png'],
    ['icon48.png', 'image/png'],
    ['icon128.png', 'image/png'],
    ['magnet.js', 'text/javascript;charset=utf-8', 200, 400],
    ['manifest.json', 'application/json;charset=utf-8', 1000, 1500],
    ['service.js', 'text/javascript;charset=utf-8', 2000, 4000],
    // ['sw.js', 'text/javascript;charset=utf-8', 500, 1000],
  ];
